...
proc create_hier_cell_AFU { parentCell nameHier } {
  ...
  # Create instance: finn_design_0, and set properties
  set finn_design_0 [ create_bd_cell -type ip -vlnv xilinx_finn:finn:finn_design finn_design_0 ]
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net AFU_base_ip_IP_M_AXI_LITE_CTRL [get_bd_intf_pins AFU_base_ip/IP_M_AXI_LITE_CTRL] [get_bd_intf_pins axi_dma_0/S_AXI_LITE]
  ...
  connect_bd_intf_net -intf_net axis_dwidth_converter_0_M_AXIS [get_bd_intf_pins axis_dwidth_converter_0/M_AXIS] [get_bd_intf_pins finn_design_0/in0_V_V_0]
  ...
  connect_bd_intf_net -intf_net finn_design_0_out_r_0 [get_bd_intf_pins axis_dwidth_converter_1/S_AXIS] [get_bd_intf_pins finn_design_0/out_r_0]
  connect_bd_intf_net -intf_net hier_0_M00_AXI [get_bd_intf_pins AFU_base_ip/IP_S_AXI_FULL_DATA] [get_bd_intf_pins axi_interconnect_0/M00_AXI]

  # Create port connections
  connect_bd_net -net AFU_Res_0 [get_bd_pins M_USR_IRQ_PORT] [get_bd_pins AFU_base_ip/M_USR_IRQ_PORT]
  connect_bd_net -net AFU_base_ip_ip_axi_aclk_ctrl [get_bd_pins AFU_base_ip/ip_axi_aclk_ctrl] [get_bd_pins axi_dma_0/s_axi_lite_aclk]
  connect_bd_net -net AFU_base_ip_ip_axi_aclk_data [get_bd_pins AFU_base_ip/ip_axi_aclk_data] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axis_dwidth_converter_0/aclk] [get_bd_pins axis_dwidth_converter_1/aclk] [get_bd_pins finn_design_0/ap_clk_0]
  connect_bd_net -net AFU_base_ip_ip_axi_aresetn_data [get_bd_pins AFU_base_ip/ip_axi_aresetn_data] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axis_dwidth_converter_0/aresetn] [get_bd_pins axis_dwidth_converter_1/aresetn] [get_bd_pins finn_design_0/ap_rst_n_0]
  ...
  connect_bd_net -net axi_aclk_role_data_1 [get_bd_pins axi_aclk_data_port] [get_bd_pins AFU_base_ip/axi_aclk_data_port]
  ...
  connect_bd_net -net axi_aresetn_role_data_0_1 [get_bd_pins axi_aresetn_data_port] [get_bd_pins AFU_base_ip/axi_aresetn_data_port]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins AFU_base_ip/IP_S_USR_IRQ] [get_bd_pins xlconstant_0/dout]
...
proc create_root_design { parentCell } {
  ...
  create_bd_addr_seg -range 0x000100000000 -offset 0x00000000 [get_bd_addr_spaces AFU/axi_dma_0/Data_MM2S] [get_bd_addr_segs M_AXI_FULL_DATA_PORT/Reg] SEG_M_AXI_FULL_DATA_PORT_Reg
  create_bd_addr_seg -range 0x000100000000 -offset 0x00000000 [get_bd_addr_spaces AFU/axi_dma_0/Data_S2MM] [get_bd_addr_segs M_AXI_FULL_DATA_PORT/Reg] SEG_M_AXI_FULL_DATA_PORT_Reg
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x00030000 [get_bd_addr_spaces S_AXI_LITE_CTRL_PORT] [get_bd_addr_segs AFU/axi_dma_0/S_AXI_LITE/Reg] SEG_axi_dma_0_Reg
