...
xilinx.com:hls:compute:*\
xilinx.com:hls:fetch:*\
xilinx.com:hls:load:*\
xilinx.com:ip:smartconnect:*\
xilinx.com:hls:store:*\
...
# Hierarchical cell: VTA_subsys
proc create_hier_cell_VTA_subsys { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_VTA_subsys() - Empty argument(s)!"}
     return
  }
  ...
  # Create interface pins
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 IP_M_AXI_FULL_DATA
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 IP_S_AXI_LITE_CTRL

  # Create pins
  create_bd_pin -dir O IP_M_USR_IRQ
  create_bd_pin -dir I -type clk ip_axi_aclk_ctrl
  create_bd_pin -dir I -type clk ip_axi_aclk_data
  create_bd_pin -dir I -type rst ip_axi_aresetn_data
  ...
  set compute_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:compute compute_0 ]

  # Create instance: fetch_0, and set properties
  set fetch_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:fetch fetch_0 ]

  # Create instance: load_0, and set properties
  set load_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:load load_0 ]
  ...
  set store_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:store store_0 ]
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins IP_S_AXI_LITE_CTRL] [get_bd_intf_pins smartconnect_1/S00_AXI]
  connect_bd_intf_net -intf_net compute_0_g2l_dep_queue_V [get_bd_intf_pins compute_0/g2l_dep_queue_V] [get_bd_intf_pins load_0/g2l_dep_queue_V]
  connect_bd_intf_net -intf_net compute_0_g2s_dep_queue_V [get_bd_intf_pins compute_0/g2s_dep_queue_V] [get_bd_intf_pins store_0/g2s_dep_queue_V]
  connect_bd_intf_net -intf_net compute_0_inp_mem_V_PORTA [get_bd_intf_pins blk_mem_gen_3/BRAM_PORTA] [get_bd_intf_pins compute_0/inp_mem_V_PORTA]
  connect_bd_intf_net -intf_net compute_0_m_axi_data_port [get_bd_intf_pins compute_0/m_axi_data_port] [get_bd_intf_pins smartconnect_0/S04_AXI]
  connect_bd_intf_net -intf_net compute_0_m_axi_uop_port [get_bd_intf_pins compute_0/m_axi_uop_port] [get_bd_intf_pins smartconnect_0/S03_AXI]
  connect_bd_intf_net -intf_net compute_0_out_mem_V_PORTA [get_bd_intf_pins blk_mem_gen_6/BRAM_PORTA] [get_bd_intf_pins compute_0/out_mem_V_PORTA]
  connect_bd_intf_net -intf_net compute_0_wgt_mem_0_V_PORTA [get_bd_intf_pins blk_mem_gen_4/BRAM_PORTA] [get_bd_intf_pins compute_0/wgt_mem_0_V_PORTA]
  connect_bd_intf_net -intf_net compute_0_wgt_mem_1_V_PORTA [get_bd_intf_pins blk_mem_gen_5/BRAM_PORTA] [get_bd_intf_pins compute_0/wgt_mem_1_V_PORTA]
  connect_bd_intf_net -intf_net fetch_0_gemm_queue_V_V [get_bd_intf_pins compute_0/gemm_queue_V_V] [get_bd_intf_pins fetch_0/gemm_queue_V_V]
  connect_bd_intf_net -intf_net fetch_0_load_queue_V_V [get_bd_intf_pins fetch_0/load_queue_V_V] [get_bd_intf_pins load_0/load_queue_V_V]
  connect_bd_intf_net -intf_net fetch_0_m_axi_ins_port [get_bd_intf_pins fetch_0/m_axi_ins_port] [get_bd_intf_pins smartconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net fetch_0_store_queue_V_V [get_bd_intf_pins fetch_0/store_queue_V_V] [get_bd_intf_pins store_0/store_queue_V_V]
  connect_bd_intf_net -intf_net load_0_inp_mem_V_PORTA [get_bd_intf_pins blk_mem_gen_0/BRAM_PORTA] [get_bd_intf_pins load_0/inp_mem_V_PORTA]
  connect_bd_intf_net -intf_net load_0_l2g_dep_queue_V [get_bd_intf_pins compute_0/l2g_dep_queue_V] [get_bd_intf_pins load_0/l2g_dep_queue_V]
  connect_bd_intf_net -intf_net load_0_m_axi_data_port [get_bd_intf_pins load_0/m_axi_data_port] [get_bd_intf_pins smartconnect_0/S01_AXI]
  connect_bd_intf_net -intf_net load_0_wgt_mem_0_V_PORTA [get_bd_intf_pins blk_mem_gen_1/BRAM_PORTA] [get_bd_intf_pins load_0/wgt_mem_0_V_PORTA]
  connect_bd_intf_net -intf_net load_0_wgt_mem_1_V_PORTA [get_bd_intf_pins blk_mem_gen_2/BRAM_PORTA] [get_bd_intf_pins load_0/wgt_mem_1_V_PORTA]
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins IP_M_AXI_FULL_DATA] [get_bd_intf_pins smartconnect_0/M00_AXI]
  connect_bd_intf_net -intf_net smartconnect_1_M00_AXI [get_bd_intf_pins fetch_0/s_axi_CONTROL_BUS] [get_bd_intf_pins smartconnect_1/M00_AXI]
  connect_bd_intf_net -intf_net smartconnect_1_M01_AXI [get_bd_intf_pins load_0/s_axi_CONTROL_BUS] [get_bd_intf_pins smartconnect_1/M01_AXI]
  connect_bd_intf_net -intf_net smartconnect_1_M02_AXI [get_bd_intf_pins smartconnect_1/M02_AXI] [get_bd_intf_pins store_0/s_axi_CONTROL_BUS]
  connect_bd_intf_net -intf_net smartconnect_1_M03_AXI [get_bd_intf_pins compute_0/s_axi_CONTROL_BUS] [get_bd_intf_pins smartconnect_1/M03_AXI]
  connect_bd_intf_net -intf_net store_0_m_axi_data_port [get_bd_intf_pins smartconnect_0/S02_AXI] [get_bd_intf_pins store_0/m_axi_data_port]
  connect_bd_intf_net -intf_net store_0_out_mem_V_PORTA [get_bd_intf_pins blk_mem_gen_7/BRAM_PORTA] [get_bd_intf_pins store_0/out_mem_V_PORTA]
  connect_bd_intf_net -intf_net store_0_s2g_dep_queue_V [get_bd_intf_pins compute_0/s2g_dep_queue_V] [get_bd_intf_pins store_0/s2g_dep_queue_V]

  # Create port connections
  connect_bd_net -net aclk_1 [get_bd_pins ip_axi_aclk_ctrl] [get_bd_pins smartconnect_1/aclk]
  connect_bd_net -net axi_aclk_role_data_1 [get_bd_pins ip_axi_aclk_data] [get_bd_pins compute_0/ap_clk] [get_bd_pins fetch_0/ap_clk] [get_bd_pins load_0/ap_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_1/aclk1] [get_bd_pins store_0/ap_clk]
  connect_bd_net -net axi_aresetn_role_data_0_1 [get_bd_pins ip_axi_aresetn_data] [get_bd_pins compute_0/ap_rst_n] [get_bd_pins fetch_0/ap_rst_n] [get_bd_pins load_0/ap_rst_n] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins smartconnect_1/aresetn] [get_bd_pins store_0/ap_rst_n]
  connect_bd_net -net compute_0_interrupt [get_bd_pins compute_0/interrupt] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net fetch_0_interrupt [get_bd_pins fetch_0/interrupt] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net load_0_interrupt [get_bd_pins load_0/interrupt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net store_0_interrupt [get_bd_pins store_0/interrupt] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net util_reduced_logic_0_Res [get_bd_pins IP_M_USR_IRQ] [get_bd_pins util_reduced_logic_0/Res]
...
proc create_hier_cell_AFU { parentCell nameHier } {
  ...
  create_hier_cell_AFU_base_ip $hier_obj AFU_base_ip

  # Create instance: VTA_subsys
  create_hier_cell_VTA_subsys $hier_obj VTA_subsys

  # Create interface connections
  connect_bd_intf_net -intf_net IP_S_AXI_FULL_DATA_1 [get_bd_intf_pins AFU_base_ip/IP_S_AXI_FULL_DATA] [get_bd_intf_pins VTA_subsys/IP_M_AXI_FULL_DATA]
  connect_bd_intf_net -intf_net IP_S_AXI_LITE_CTRL_1 [get_bd_intf_pins AFU_base_ip/IP_M_AXI_LITE_CTRL] [get_bd_intf_pins VTA_subsys/IP_S_AXI_LITE_CTRL]
  connect_bd_intf_net -intf_net S_AXI_LITE_ROLE_CTRL_1 [get_bd_intf_pins S_AXI_LITE_CTRL_PORT] [get_bd_intf_pins AFU_base_ip/S_AXI_LITE_CTRL_PORT]
  connect_bd_intf_net -intf_net S_BSCAN_0_1 [get_bd_intf_pins S_BSCAN_PORT] [get_bd_intf_pins AFU_base_ip/S_BSCAN_PORT]
  connect_bd_intf_net -intf_net axi_interconnect_1_M00_AXI [get_bd_intf_pins M_AXI_FULL_DATA_PORT] [get_bd_intf_pins AFU_base_ip/M_AXI_FULL_DATA_PORT]

  # Create port connections
  connect_bd_net -net AFU_Res_0 [get_bd_pins M_USR_IRQ_PORT] [get_bd_pins AFU_base_ip/M_USR_IRQ_PORT]
  connect_bd_net -net AFU_base_ip_ip_axi_aclk_ctrl [get_bd_pins AFU_base_ip/ip_axi_aclk_ctrl] [get_bd_pins VTA_subsys/ip_axi_aclk_ctrl]
  connect_bd_net -net I_ROLE_RSTN_1 [get_bd_pins I_RSTN_PORT] [get_bd_pins AFU_base_ip/I_RSTN_PORT]
  connect_bd_net -net axi_aclk_data_port_1 [get_bd_pins axi_aclk_data_port] [get_bd_pins AFU_base_ip/axi_aclk_data_port]
  connect_bd_net -net axi_aclk_role_ctrl_1 [get_bd_pins axi_aclk_ctrl_port] [get_bd_pins AFU_base_ip/axi_aclk_ctrl_port]
  connect_bd_net -net axi_aclk_role_data_1 [get_bd_pins AFU_base_ip/ip_axi_aclk_data] [get_bd_pins VTA_subsys/ip_axi_aclk_data]
  connect_bd_net -net axi_aresetn_data_port_1 [get_bd_pins axi_aresetn_data_port] [get_bd_pins AFU_base_ip/axi_aresetn_data_port]
  connect_bd_net -net axi_aresetn_role_ctrl_0_1 [get_bd_pins axi_aresetn_ctrl_port] [get_bd_pins AFU_base_ip/axi_aresetn_ctrl_port]
  connect_bd_net -net axi_aresetn_role_data_0_1 [get_bd_pins AFU_base_ip/ip_axi_aresetn_data] [get_bd_pins VTA_subsys/ip_axi_aresetn_data]
  connect_bd_net -net util_reduced_logic_0_Res [get_bd_pins AFU_base_ip/IP_S_USR_IRQ] [get_bd_pins VTA_subsys/IP_M_USR_IRQ]
...
proc create_root_design { parentCell } {
  ...
  create_bd_addr_seg -range 0x000100000000 -offset 0x00000000 [get_bd_addr_spaces AFU/VTA_subsys/compute_0/Data_m_axi_uop_port] [get_bd_addr_segs M_AXI_FULL_DATA_PORT/Reg] SEG_M_AXI_FULL_DATA_PORT_Reg
  create_bd_addr_seg -range 0x000100000000 -offset 0x00000000 [get_bd_addr_spaces AFU/VTA_subsys/compute_0/Data_m_axi_data_port] [get_bd_addr_segs M_AXI_FULL_DATA_PORT/Reg] SEG_M_AXI_FULL_DATA_PORT_Reg
  create_bd_addr_seg -range 0x000100000000 -offset 0x00000000 [get_bd_addr_spaces AFU/VTA_subsys/fetch_0/Data_m_axi_ins_port] [get_bd_addr_segs M_AXI_FULL_DATA_PORT/Reg] SEG_M_AXI_FULL_DATA_PORT_Reg
  create_bd_addr_seg -range 0x000100000000 -offset 0x00000000 [get_bd_addr_spaces AFU/VTA_subsys/load_0/Data_m_axi_data_port] [get_bd_addr_segs M_AXI_FULL_DATA_PORT/Reg] SEG_M_AXI_FULL_DATA_PORT_Reg
  create_bd_addr_seg -range 0x000100000000 -offset 0x00000000 [get_bd_addr_spaces AFU/VTA_subsys/store_0/Data_m_axi_data_port] [get_bd_addr_segs M_AXI_FULL_DATA_PORT/Reg] SEG_M_AXI_FULL_DATA_PORT_Reg
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x00024000 [get_bd_addr_spaces S_AXI_LITE_CTRL_PORT] [get_bd_addr_segs AFU/VTA_subsys/compute_0/s_axi_CONTROL_BUS/Reg] SEG_compute_0_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x00021000 [get_bd_addr_spaces S_AXI_LITE_CTRL_PORT] [get_bd_addr_segs AFU/VTA_subsys/fetch_0/s_axi_CONTROL_BUS/Reg] SEG_fetch_0_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x00022000 [get_bd_addr_spaces S_AXI_LITE_CTRL_PORT] [get_bd_addr_segs AFU/VTA_subsys/load_0/s_axi_CONTROL_BUS/Reg] SEG_load_0_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x00023000 [get_bd_addr_spaces S_AXI_LITE_CTRL_PORT] [get_bd_addr_segs AFU/VTA_subsys/store_0/s_axi_CONTROL_BUS/Reg] SEG_store_0_Reg
